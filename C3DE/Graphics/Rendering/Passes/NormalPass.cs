...
{
    public class NormalPass : RenderPass
    {
        public NormalPass(GraphicsDevice graphicsDevice) : base(graphicsDevice)
        {
        }
        ...
        public override void LoadContent(ContentManager content)
        {
            ...
            _renderTarget = new RenderTarget2D(_graphicsDevice, pp.BackBufferWidth, pp.BackBufferHeight, false, SurfaceFormat.Color, DepthFormat.Depth24);
            _effect = content.Load<Effect>("Shaders/Normal");
        }
