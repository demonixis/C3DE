...
namespace C3DE.VR
{
    ...
    public class OpenHMDService : VRService
    {
        ...
        public override uint[] GetRenderTargetSize() => new[] { (uint)_hmdDescription.HorizontalResolution, (uint)_hmdDescription.VerticalResolution };

        public override RenderTarget2D CreateRenderTargetForEye(int eye)
        {
            return new RenderTarget2D(Game.GraphicsDevice, _hmdDescription.HorizontalResolution, _hmdDescription.VerticalResolution, false, SurfaceFormat.Color, DepthFormat.Depth24Stencil8);
        }
