...
- **`CLAUDE.md`** : mettre à jour dès qu'une modification architecturale est faite (nouveau système, changement d'API clé, nouvelle dépendance, convention modifiée). Ce fichier est la source de vérité pour le travail assisté par IA.
